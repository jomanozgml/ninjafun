# Description: Scrapes a URL and returns the HTML source from dynamic page using Selenium
# Add the following in requirements.txt: selenium==4.8.0
...
#     # driver = webdriver.Chrome('/root/.local/share/pyppeteer/local-chromium/588429', options = options)
